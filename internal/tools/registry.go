...
func NewRegistry(authKey string) *Registry {
	...
	r.Register(&ModelInfoTool{})
	r.Register(&SearchModelsTool{})
	r.Register(&GetPricingTool{})
	r.Register(&EstimateCostTool{})
	r.Register(&CheckUsageTool{})
	r.Register(&GetAnalyticsTool{})
	r.Register(&RequestHistoryTool{})
	r.Register(&ListWorkflowsTool{})
